    ...
    <div className="min-h-screen bg-theme-bg flex items-center justify-center p-4">
        <div className="w-full max-w-md rounded-2xl bg-theme-surface shadow-2xl shadow-black/20 overflow-hidden">
             <div className="p-8 md:p-12">
                ...
                <h1 className="text-3xl font-bold text-theme-text-primary mb-2 text-center">Welcome Back</h1>
                <p className="text-theme-text-secondary mb-6 text-center">Sign in to find your perfect partner.</p>
                 ...
                 <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            className="w-full px-4 py-3 bg-theme-bg border border-theme-border rounded-lg text-theme-text-primary focus:outline-none focus:ring-2 focus:ring-theme-accent-primary"
                        />
                    </div>
                    <div className="mb-4">
